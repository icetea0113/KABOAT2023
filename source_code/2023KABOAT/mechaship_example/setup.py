...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "pid_go = mechaship_example.pid_go:main",
            "now_heading = mechaship_example.now_heading:main",
            "relative_heading = mechaship_example.relative_heading:main",
            "pid_go_2 = mechaship_example.pid_go2:main",
            "greenlight = mechaship_example.greenlight:main",
            "act = mechaship_example.act:main"
        ],
    },
)
