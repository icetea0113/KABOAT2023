...
def generate_launch_description():
      return LaunchDescription([
          ...
          DeclareLaunchArgument('mountpoint',            default_value='CHWN-RTCM31'), 
          DeclareLaunchArgument('ntrip_version',         default_value='2.0'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='v2msyo@naver.com'),
