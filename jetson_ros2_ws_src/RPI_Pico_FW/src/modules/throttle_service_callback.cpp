...
void left_throttle_service_set_percentage_callback(const void *req_p_, void *res_p_) {
  ...
  bool ret = bsp_throttle_set_by_percentage(&throttle_left_h, req_p->percentage);
  res_p->status = ret;
}
...
void left_throttle_service_set_pulse_width_callback(const void *req_p_, void *res_p_) {
  ...
  bool ret = bsp_throttle_set_by_pulse_width(&throttle_left_h, req_p->pulse_width);
  res_p->status = ret;
}
...
void right_throttle_service_set_percentage_callback(const void *req_p_, void *res_p_) {
  ...
  bool ret = bsp_throttle_set_by_percentage(&throttle_right_h, req_p->percentage);
  res_p->status = ret;
}
...
void right_throttle_service_set_pulse_width_callback(const void *req_p_, void *res_p_) {
  ...
  bool ret = bsp_throttle_set_by_pulse_width(&throttle_right_h, req_p->pulse_width);
  res_p->status = ret;
}