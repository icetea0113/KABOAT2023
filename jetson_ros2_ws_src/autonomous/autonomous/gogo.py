...
class Autonomous(Node):
    ...
    def get_xy(self, e, n,angle):
        x = e * math.cos(angle) + n * math.sin(angle) + self.stadium_enu[0][0]
        y = -e * math.sin(angle) + n * math.cos(angle) + self.stadium_enu[0][1]
        return x,y
